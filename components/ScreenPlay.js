...
export default function GameScreen({ navigation }) {
  ...
  const [getDisPrice, setDisPrice] = useState();
  ...
  const numClick = (e) => {
    if (e === 'Calculate') {
      ...
      setList([
            { price: getPrice , discount: getDiscount , disPrice: getDisPrice } 
      ]);
    }    
    ...
    />
      ...
      <View style={styles.buttonframe}>
        <TouchableOpacity
          ...
          <Text style={styles.appButtonText}>History</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.buttonframe}>
        <TouchableOpacity
      ...
      <View> 
          ...
          {getList.map((item) =>
              ...
              <View style={styles.scrollviewItem}>
                <Text style={styles.scrollviewText}>{`Entered Price : ${item.price}\nEntered Discount % :  ${item.Discount}\nDiscounted Price :  ${item.disPrice}\n`}</Text>
              </View>
          )}
         </ScrollView>
        </View>
